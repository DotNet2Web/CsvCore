...
namespace CsvCore.ApiVerificationTests;
...
public class ApiApproval
{
    ...
    public Task ApproveApi(string framework)
    {
        ...
        var assemblyFile = CombinedPaths("CsvCore", "bin", configuration, framework, "CsvCore.dll");
    ...
    private class TargetFrameworksTheoryData : TheoryData<string>
    {
        ...
        {
            var csproj = CombinedPaths("CsvCore", "CsvCore.csproj");
