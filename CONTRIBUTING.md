...
Before filing a new issue, please search our [issues](https://github.com/DotNet2Web/CsvSharp/issues) to check if it already exists.
...
When ready to submit a bug report, please use the [Bug Report issue template](https://github.com/DotNet2Web/CsvSharp/issues/new?labels=&template=01_bug_report.yml).
...
When ready to submit a proposal, please use the [API Suggestion issue template](https://github.com/DotNet2Web/CsvSharp/issues/new?labels=api-suggestion&template=02_api_proposal.yml&title=%5BAPI+Proposal%5D%3A+).
